...
{
    public Snake_boid snakeBoid; // Reference to Snake_boid script
    ...
    void CalculateHarmonicMotion()
    {
        ...
        // Apply harmonic motion as a steering force to the snake boid
        Vector3 steeringForce = snakeBoid.SeekForce(worldTarget);
        snakeBoid.ApplyForce(steeringForce);
    }
}
